...
local Window = Library:new("小yo中心 fa");
...
local OH = Window:Tab("CDID",'16060333448')
local HO = OH:section("主要刷钱",true)
local HQ = OH:section("次要刷钱",true)
...
about:Label("作者小yo")
about:Label("作者qq3698091617")
about:Label("正在努力优化")
about:Label("请勿倒卖")
about:Button("复制作者QQ", function()
    setclipboard("3698091617")
end)
about:Button("复制QQ群", function()
    setclipboard("1055935003")
end)
